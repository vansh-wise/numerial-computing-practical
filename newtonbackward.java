public class newtonbackward {
    public static void main(String[] args) {
        ...
        double root = newtonBackward(x0, tol, maxIter);
        System.out.println("Root: " + root);
    }

    public static double newtonBackward(double x0, double tol, int maxIter) {
        double x = x0;
        for (int i = 0; i < maxIter; i++) {
            ...
            double xNew = x + fx / dfx; // Newton's method formula for backward
